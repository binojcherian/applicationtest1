                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#ffffff">&nbsp;
                                                        <%-- Content --%>
                                            <center>
                                                <form id="ResultStatistics" name="ResultStatistics" action="ResultStatistics.jsp" method="post">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <select name="Exam" id="Exam" style="width: 300px">
                                                                                    ...
                                                                                    %>
                                                                                    <option <%if (stat.getExam().equals(exam.ExamId)) {
                                                                   out.print("selected");
                                                               }%>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <select name="Course" id="Course" style="width: 250px" onchange="ChangeYearOrSem();">
                                                                                    ...
                                                                                    %>
                                                                                    <option <%if (Integer.parseInt(stat.getBranch()) == Course.BranchId) {
                                                                    out.print("selected");
                                                                }%>
                                                    ...
                                                    while(i<=count)
                                                        ...
                                                        <option <%if(Integer.parseInt(stat.getSemYear())==i){ out.print("selected");}  %> value=<%=i%>><%=i %></option>
                                                                                        ...
                                                                                        <center>
                                                                                            <table BORDER="1"  style="border-style: groove" cellspacing="0" cellpadding="3" class="textblack">
                                                                                                <tr  bgcolor="#ddcccc" align="center">
                                                                                                    ...
                                                                                                    <th class="textblack">Total Absent</th>
                                                                                                ...
                                                                                                <tr>
                                                                                                  ...
                                                                                                  <!--<td class="textblack"><!%=ReStat.SubBranchName%></td>-->
                                                                                                    ...
                                                                                                    <td class="textblack"><%=ReStat.TotalPass%></td>
                                                                                                     <td class="textblack"><%=ReStat.TotalAbsent%></td>
                                                                                                ...
                                                                                                <table    cellspacing="0" cellpadding="3" class="textblack">
                                                                                                    <tr>
                                                                                                        <td class="textblack" align="center">
                                                                                                            <input type="radio" name="ModerationType" id="ModerationType" <%if (stat.IsBranchModeration()) {
                                                            out.print("checked");
                                                        }%> value="0" onclick="ChangeModerationType()" >Semester Moderation
                                                                                                            <input type="radio" name="ModerationType" id="ModerationType" <%if (!stat.IsBranchModeration()) {
                                                            out.print("checked");
                                                        }%> value="1" onclick="ChangeModerationType()">Subject Moderation
                                                                                                        </td>
                                                                                                    </tr>
                                                                                                </table>
                                                                                            </td>
                                                                                                ...
                                                                                                <fieldset ><legend><span style="color:#a02a28; font-size: small"><b>Prepare For Moderation</b></span></legend>
                                                                                                    <div id="BranchWiseModeration" >
                                                                                                        <table>
                                                                                                            ...
                                                                                                            <tr id="SubjectList" <%if (stat.IsBranchModeration()) {
                                                            out.print("style=\"display: none\"");
                                                                                                                ...
                                                                                                                <td>
                                                                                                                    ...
                                                                                                                    <select name="Subject" id="Subject" style="width: 250px" onchange="getStatusOfAbsEntry();">
                                                                                                                        ...
                                                                                                                        <option <%if (stat.getSubject().equals(sub.SubjectBranchId)) {
                                                                                           out.print("selected");
                                                                                       }%>
                                                                                                            ...
                                                                                                            <tr><td align="right"><a href="#" onclick="printInfo();">Print Now</a></td></tr>
                                                                                                            <tr id="BranchModeration" <%if (!stat.IsBranchModeration()) {
                                                            out.print("style=\"display: none\"");
                                                        }%>>
                                                                                                                <td>
                                                                                                                    <%
                                                            ...
                                                            if (Count > 0) {%>
                                                                                                            ...
                                                                                                            <tr id="SubjectModeration" <%if (stat.IsBranchModeration()) {
                                                                 out.print("style=\"display: none\"");
                                                             }%>>
                                                                 ...
                                                                 if (Count > 0) {%>
                                                                                                                ...
                                                                                                                <tr bgcolor="#ddcccc">
                                                                                                                    ...
                                                                                                                    <th class="textblack" width="20%"> Pass</th>
...
<script>
    function printInfo()
    {
        var  exam="",course="",yearsem="",subject="",ModerationFrom="",ModerationTo="",ModerationType="0",Subject="-1"; 
        ...
        ModerationFrom=document.getElementById("ModerationFrom").value;
        ModerationTo=document.getElementById("ModerationTo").value;
        if(document.ResultStatistics.ModerationType[0].checked)
        {
            ModerationType=0;
        }
        if(document.ResultStatistics.ModerationType[1].checked)
        {
            ModerationType=1;
             Subject=document.getElementById("Subject").value;
        }
       
        var orgurl = "PrintStatistics.jsp?Exam="+exam+"&Course="+course+"&YearSem="+yearsem+"&ModerationFrom="+ModerationFrom+"&ModerationTo="+ModerationTo+"&ModerationType="+ModerationType+"&Subject="+Subject;
