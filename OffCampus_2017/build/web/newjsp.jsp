<%-- 
    Document   : newjsp
    Created on : Feb 14, 2012, 11:47:58 AM
    Author     : user
--%>
                                            ...
                                            <input type="Submit" name="Submit" id="Submit" value="Search">
                                             ...
                                             <table BORDER="1"  style="border-style: groove" cellspacing="0" cellpadding="3" class="textblack" width="80%">
                                                        <tr  bgcolor="#ddcccc" align="center">
                                                            <th class="textblack">Select</th>
                                                            <th class="textblack">Subject Name</th>
                                                            <th class="textblack">Has Separate Moderation</th>
                                                            <th class="textblack">Moderation</th>
                                                        </tr>
                                                        <%while(i<Count)
                                                            {
                                                ...
                                                %>
                                                            <tr>
                                                                <td class="textblack"align="center"><input type="checkbox" name="Select"id="Select" Value="<%=Sub.SubjectBranchId %>" onclick="return SelectAllRows(this.form) "> </td>
                                                                <td class="textblack"><%=Sub.SubjectName %></td>
                                                                <td class="textblack"align="center"><input type="checkbox" name="chk"id="chk" onclick="return EnableModeration(<%=i%>);"> </td>
                                                                <td><input type="text" name="SeparateModeration" id="SeparateModeration" value=""  maxlength="2" readonly="true" style="width:60px" onkeypress="return chkNumberOnly(event);"></td>
                                                            </tr>
                                               <%i++;}%>
                                               <tr>
                                                   <td class="textblack">
                                               ...
                                               <table width="80%">
                                                   ...
                                                   <td align="left" class="textblack" >
                                                       <input type="checkbox" name="ForDistinction" id="ForDistinction" value="1" onclick="return EnableClassModeration(this.form)">
                                                        Moderation To be applied for improving the percentage of Distinction
                                                   </td>
                                                   <td>
                                               ...
                                               <tr>
                                                   <td align="left" class="textblack" >
                                                       <input type="checkbox" name="ForFirst" id="ForFirst" value="1" onclick="return EnableClassModeration(this.form)">
                                                        Moderation To be applied for improving the percentage of First Class
                                                   </td>
                                                   <td>
                                               ...
                                               <tr>
                                                   <td align="left" class="textblack" >
                                                       <input type="checkbox" name="ForSecond" id="ForSecond" value="1" onclick="return EnableClassModeration(this.form)">
                                                        Moderation To be applied for improving the percentage of Second class
                                                   </td>
                                                   <td>
                                                   ...
                                                   <table style="border-style: groove" cellspacing="0" cellpadding="3" class="textblack" width="100%" align="center">
                                                       <tr>
                                                            <td colspan="2" class="textblack">
                                                                   <input type="radio" name="Class" id="Class" Value="SemPass">Moderation can be applid only for Semester Pass
                                                            </td>
                                                        </tr>
                                                       <tr>
                                                       <td  class="textblack">
