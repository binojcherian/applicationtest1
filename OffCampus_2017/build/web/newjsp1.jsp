                ...
                <table   width="100%" style=" min-height: 500px;" cellspacing="0" cellpadding="3" >
                    ...
                    %>
                        ...
                        while(i<count)
                            {
                                int Sem=0;
                            Entity.StudentData Student=StudentList.get(i);
                            boolean flag=true,EngFailed=false;
                        %>
                        <div <% if(((i+1)%var==0 || (!Student.CollegeId.equals(PrevCentre))) && i>1){ %>  class="break"<% }%>>
                                ...
                                <td colspan="3" align="center" class="textblack">
                                    <table border="1"  width="100%" style="border-style: groove; " cellspacing="0" cellpadding="3" >
                                          <tr>
                                            ...
                                            <td class="textblack" colspan="3"><div align="center">External </div></td>
                                          ...
                                          <tr>
                                            ...
                                            <td class="textblack"><div align="center">Moderation</div></td>
                                            <td class="textblack"><div align="center">Min</div></td>
                                            <td class="textblack"><div align="center">Mark</div></td>
                                            <td class="textblack"><div align="center">Moderation</div></td>
                                            <td class="textblack"><div align="center">Min</div></td>
...
if(!request.getParameter("Exam").equals(Tab.ExamId))
{
    fontcolor="red";
}
//CHECKING ENDS HERE
                                        ...
                                        <tr>
                                            ...
                                            <td class="textblack"><%if(Tab.ModerationExt.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.ModerationExt %></font><% } %></td>
                                            <td class="textblack"><%if(Tab.IntMin.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.IntMin %></font><% } %></td>
                                            <td class="textblack"><%if(Tab.InternalMark.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.InternalMark %></font><% } %></td>
                                            <td class="textblack"><%if(Tab.ModerationInt.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.ModerationInt %></font><% } %></td>
                                            <td class="textblack"><%if(Tab.PassMark.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.PassMark %></font><% } %></td>
                                            <td class="textblack"><%if(Tab.TotalMark.equals(" ")){ %>&nbsp;<% }else {%><font color="<%=fontcolor %>"><%=Tab.TotalMark %></font><% } %></td>
                                             <% if(Tab.SubjectBranchId.equals("61") || Tab.SubjectBranchId.equals("72")) {%>
                                            <td>&nbsp;</td><% } else{%>
                                            <td class="textblack"><font color="<%=fontcolor %>"><%=Tab.Status %></font></td><% }%>
                                        ...
                                        <% if(((!Student.BranchId.equals("7"))&& (!Student.BranchId.equals("8"))))
                                            {%>
                                        <tr>
                                            <td class="textblack" colspan="10" align="right" height="20px"><b>Grand Total</b></td>
                                            <%if(Student.BranchId.equals("13")){ %>
                                            <td class="textblack"><% if(flag && Integer.parseInt(mark.getSemTotalForStudent(Student.StudentId, con))>=mark.getTotalPassMarkForBLiSc(con) ){%><%=mark.getSemTotalForStudent(Student.StudentId, con) %><% } else{%>&nbsp;<% }%></td>
                                            <% }else{%>
                                            <td class="textblack"><% if(flag){%><%=mark.getSemTotalForStudent(Student.StudentId, con) %><% } else{IsGPassed=false; %>&nbsp;<% }%></td>
                                            <% }%>
                                        </tr>
                                        <%}}%>
                                        ...
                                        if(Student.BranchId.equals("5") || Student.BranchId.equals("9")) {%>
                                        <tr>
                                            <td class="textblack" colspan="10" align="right"><b>Grand Total for English Paper I and II</b></td>
                                        ...
                                        if(mark.getSemYear().equals("4") && mark.getBranch().equals("17")){
                                            ...
                                            %>
                                        <tr>
                                            <td class="textblack" colspan="10" align="right">Grand Total for Semester <%=x %></td>
                                            <td class="textblack"><%if(mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con,x) ){%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con,x) %><% }else{IsGPassed=false; %>&nbsp; <%}%></td>

                                        </tr>

                                        <%}%>
                                        <tr>
                                            <td class="textblack" colspan="10" align="right"><b>Grand Total </b></td>
