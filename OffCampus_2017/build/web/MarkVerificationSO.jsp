            ...
            <form id="MarkVerificationSO" name="MarkVerificationSO" action="MarkVerificationSO.jsp" method="post">
                ...
                <center>
                        ...
                        <% } %>
                                ...
                                <td align="left">
                                 ...
                                 %>
                                    ...
                                    <br>
                                    <center>
                                     <font  color="#ff7f01"><b>   <%if(request.getSession().getAttribute("Error")!=null) {%>
                        <%=request.getSession().getAttribute("Error").toString()%>
                        <% } %> 
                        <%if(request.getSession().getAttribute("Error1")!=null) {%>
                        <%=request.getSession().getAttribute("Error1").toString()%>
                        <% } %> 
                                         </b></font>
                    ...
                    <tr id="MarkList" name="MarkList">
                        ...
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="practical" name="practical" value="<%=stu.PracticalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);"></td>
                        <td class="textblack" align="left"><%=Double.parseDouble(stu.ExternalMark)+ Double.parseDouble(stu.InternalMark)+ Double.parseDouble(stu.PracticalMark)%></td>
                        <td class="textblack" align="left"><input type="button" name="SubmitEdit" id="SubmitEdit" value="Edit" onclick="return OpenTextForEdit(<%=i%>);" </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="9" align="right">
                            <input type="Submit" name="Submit" id="Submit"  value="Approve"  onClick="return openNewWindow(this.form);">
                        </td>
                    </tr>
                    <% }
                    //return openNewWindow(this.form)
                    %>
                </table> </center>
                                    </center>
                            </fieldset>
