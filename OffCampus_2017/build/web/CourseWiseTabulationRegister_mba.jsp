                                            ...
                                            <tbody><tr>
                                                ...
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                        ...
                                                        <!--    <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><%if(mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con,Integer.toString(1)) ) { if (Status == null){%>
                                                                                                        <%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con,1)%><% }} else {
                                                IsGPassed = false;%>&nbsp; <%}%></td>
