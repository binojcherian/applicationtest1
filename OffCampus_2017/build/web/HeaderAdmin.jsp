<%-- 
    Document   : Header_SO
    Created on : Oct 29, 2011, 12:03:25 PM
    Author     : user
--%>
...
<tr align="right" ><td align="right"  style="color:#6c4303"><a href="AdminInstruction.jsp" >Home</a>  | <a href="Examregistration.jsp" >Exam Registration</a>  |  <a href="MarkCorrectionSuperAdmin.jsp" >Exam Management</a> |  <a href="Support.jsp" >Support</a> |  <a href="/OffCampus/Logout" >Logout</a>
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr valign="top" align="left">
    <td height="7" width="100%" bgcolor="#a02a28"><img src="images/spacer.gif" alt=""></td>
  </tr>
