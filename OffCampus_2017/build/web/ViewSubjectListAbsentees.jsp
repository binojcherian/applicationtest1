...
<div id="SubjectList">
    <%
    String BranchId,AcdemicYear,Sem;
    ...
    if(request.getParameter("YearSem")!= null)
     ...
     if(request.getParameter("AcdemicYear")!= null)
      ...
      %>
    <select name="SubjectSearch" id="SubjectSearch" style="width: 270px" onchange="getStatusOfAbsEntry();">
                                 <option value="-1">.....Select.....</option>
                                           ...
                                           int count=SubList.size();
                                            ...
                                            %>
                                           <option <%if(Integer.parseInt(absentee.getSubject())==Integer.parseInt(sub.SubjectId)) { out.print("selected");}%>
