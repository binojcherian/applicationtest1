...
%>
            <form id="PostCorrection" name="PostCorrection" action="PostCorrection.jsp" method="post">

                <center>
                    <table  border="1" width="98%" >
                    <tr  align="center">
                        <td height="20px" bgcolor="#d9bf79" colspan="3" > <b> <font color="#a02a28"> Post Correction By SO</font></b></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    StudentList=mark.getPostCorrectionBySO();
                    ...
                    if(Count==0)
                     ...
                     <table border="1" width="98%" style="border-style: groove" cellspacing="0" cellpadding="3">
                         ...
                         <tr class="textblack"  align="center"><span style="color:#a02a28; font-size: small"><b>Total number of Records to be verified : <%=mark.getTotalCountOfRecordsToBeVerifiedBySOPostCorrection() %></b></span></tr>
                    ...
                    <tr id="MarkList" name="MarkList">
                        ...
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="external" name="external" value="<%=stu.ExternalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);" onblur="CalculateInternalForVerificationPostCorrection(<%=i%>);"></td>
                        ...
                        <td class="textblack" align="left"><input type="button" name="SubmitEdit" id="SubmitEdit" value="Edit" onclick="return OpenTextForEditPostCorrection(<%=i%>);" </td>
                    </tr>
                    <input type="hidden" id="SubjectBranchId" name="SubjectBranchId" value="<%=stu.SubjectBranchId %>">
                    <% i++;}%>
                     <tr>
                         <td colspan="11"class="textblack" align="left"><input type="checkbox" name="SelectAll" id="SelectAll" Value="SelectAll" onclick="SelectAllRowsPostCorrection(this.form);"><b>SelectAll</b> </td>
                    </tr>
                    <tr>
