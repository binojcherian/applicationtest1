                                                                             ...
                                                                             //if (((i + 1) % var == 0 || (!Student.CollegeId.equals(PrevCentre))) && i > 1)%>
                                                                                ...
                                                                                <div class="break" ></div><% }%>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" class="textblack"><b>Exam :</b>April 2016</td>
                                                                                        ...
                                                                                        <td colspan="3" align="center" class="textblack">
                                                                                            <table border="1"  width="100%" style="border-style: groove; " cellspacing="0" cellpadding="3" >
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="textblack" colspan="2"><div align="center">Internal </div></td>
                                                                                             <!-- <td class="textblack" colspan="1"><div align="center">Practical </div></td>-->
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><% System.out.println("amma1");if (Tab.ModerationExt.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ModerationExt%></font><% }%></td>
                                                                                                    <td class="textblack"><% System.out.println("amma2");if (Tab.ClassModeration.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ClassModeration%></font><% }%></td>
                                                                                                   <td class="textblack"><%if (Tab.IntMin.equals(" ")) {%>&nbsp;<% } else {%><%=Tab.IntMin%><% }%></td>

                                                                                                    <td class="textblack"><%=Tab.InternalMark%></td>
                                                                                                    ...
                                                                                                    <td class="textblack" ><%if (Tab.oldExam.equals("1")) {%>2011<% } else if (Tab.oldExam.equals("2")) {%>2012<% }else if (Tab.oldExam.equals("3")) {%>2013<% }else if (Tab.oldExam.equals("4")) {%>2014<% }else if (Tab.oldExam.equals("5")) {%>2015<%}else if (Tab.oldExam.equals("6")) {%>2016<%}%></td>
                                                                         ...
                                                                         <%if (mark.getSemYear().equals("2")) {
                                                                            if (Student.BranchId.equals("7") || Student.BranchId.equals("8")) {%>
                                                                                          ...
                                                                                          <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><%if (mark.IsStudentPassedForBcomPartIII(Integer.parseInt(Student.StudentId), con, x) && mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x)%><% } else {
                                                ...
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                                               ...
                                                                                               <tr>
                                                                                                   ...
                                                                                                   <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 1759 ) {%> First Class with Distinction <%}else if (GTotal< 1760 && GTotal>1319){%>First Class<%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                                    <td class="textblack"><%if (IsGPassed) {if (GTotal> 539 ) {%> First Class  <%}else if (GTotal > 449 ){%>Second Class<%}}%></td>
                                                                                        ...
                                                                                        <!--     <td class="textblack"><%if (IsGPassed) {if (GTotal> 1319 ) {%> First Class  <%}else if ( GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                               ...
                                                                                               <td class="textblack"><%if (IsGPassed) {if (GTotal> 1499 ) {%> First Class  <%}else if (GTotal > 1249 ){%>Second Class<%}}%></td>
                                                                                                ...
                                                                                                <%}%>
                                                       <tr>
                                                                                                    <td class="textblack" colspan="8" align="right">Grand Total</td>
                                                                                                    <td class="textblack"><%if(mark.IsStudentPassedForBcomPartIII(Integer.parseInt(Student.StudentId), con,3) ) { if (Status == null){%>
                                                                                                        <%=mark.getSemTotalofBcomPartIII(Integer.parseInt(Student.StudentId), con,3)%><% }} else {
                                                IsGPassed = false;%>&nbsp; <%}%></td>
