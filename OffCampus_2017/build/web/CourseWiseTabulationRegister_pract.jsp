                                        ...
                                        <table width="100%" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
                                            <tbody><tr>
                                                                                              ...
                                                                                              <td class="textblack" colspan="1"><div align="center">Practical </div></td>
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="textblack" >&nbsp;</td>
                                                                                                                                    ...
                                                                                                                                    System.out.println("****************************");
                                                                                                                                             ArrayList<TabulationData> TabData = mark.getStudentMarkDetails_Bts(Student.StudentId, con);
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><% System.out.println("****************************1111111111111111111111");if (Tab.ClassModeration.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ClassModeration%></font><% }%></td>
                                                                                                   
                                                                                                    <td class="textblack"><% System.out.println("****************************1111111111111111111111"); if (Tab.IntMin.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.IntMin%></font><% }%></td>
                                                                                                    <td class="textblack"><% System.out.println("****************************1111111111111111111111");if (Tab.InternalMark.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.InternalMark%></font><% }%></td>
                                                                                                    <td class="textblack"><% if(Tab.ModerationInt.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ModerationInt%></font><% }%></td>
                                                                                                    <td class="textblack"><%   if (Tab.PracticalMark.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.PracticalMark%></font><% }%></td>
                                                                                                    ...
                                                                                                    <td class="textblack" ><%if (Tab.oldExam.equals("1")) {%>2011<% } else if (Tab.oldExam.equals("2")) {%>2012<% }else if (Tab.oldExam.equals("3")) {%>2013<% }else if (Tab.oldExam.equals("4")) {%>2014<% }else if (Tab.oldExam.equals("5")) {%>2015<% }%></td>
                                                                         ...
                                                                         <%if (mark.getSemYear().equals("2")) {
                                                                            if (Student.BranchId.equals("7") || Student.BranchId.equals("8")) {%>
                                                                                               ...
                                                                                               <% int GTotal = 0;
                                                                                                ...
                                                                                                %>
                                                                                      <!--     <tr>
                                                                                                    <td class="textblack" colspan="12" align="right"> Total for Semester <%=x%></td>
                                                                                                    <td class="textblack"><%if (mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con, Integer.toString(x)) && mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x)%><% } else {
                                                ...
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                                               ...
                                                                                               <tr>
                                                                                                    <td class="textblack" colspan="12" align="right"><b>Grand Total </b></td>
                                                                                                    <td class="textblack"><%if (IsGPassed) {%><b><%=GTotal%><% } else {%>&nbsp; <%}%></b></td>
                                                                                                    
                                                                                                   <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 1759 ) {%> First Class with Distinction <%}else if (GTotal< 1760 && GTotal>1319){%>First Class<%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                                   <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 539 ) {%> First Class  <%}else if (GTotal > 439 ){%>Second Class<%}}%></td>-->
                                                                                                    <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 899 ) {%> First Class  <%}else if (GTotal > 749 ){%>Second Class<%}}%></td>-->
                                                                                                 <!--<td class="textblack"><%if (IsGPassed) {if(Syllabus==2010){if (GTotal> 2924 ) {%> First Class with Distinction <%}else if (GTotal< 2925 && GTotal>2339){%>First Class<%}else if (GTotal > 1949 ){%>Third Class<%}}else{ if (GTotal> 2999 ) {%> First Class with Distinction <%}else if (GTotal< 3000 && GTotal>2399){%>First Class<%}else if (GTotal > 1999 ){%>Second Class<%}}}%></td>-->
                                                                                            ...
                                                                                            <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 1319 ) {%> First Class  <%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td> -->
                                                                                               ...
                                                                                               <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 1499 ) {%> First Class  <%}else if (GTotal > 1249 ){%>Second Class<%}}%></td>-->
                                                                                                     ...
                                                                                                     <td class="textblack"><%if (IsGPassed) {if (GTotal> 2799 ) {%> First Class with Distinction <%}else if (GTotal< 2800 && GTotal>2099){%>First Class<%}else if (GTotal< 2100 && GTotal>1749){%>Second Class<%}}%></td>
                                                                                               </tr> 
                                                                                                ...
                                                                                                <%}%>
                                                        <tr>
                                                                                                    <td class="textblack" colspan="12" align="right">Grand Total</td>
