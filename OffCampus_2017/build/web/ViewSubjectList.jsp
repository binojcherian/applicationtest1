...
<div id="SubjectList">
    ...
    if(request.getParameter("YearSem")!= null)
     ...
     if(request.getParameter("AcdemicYear")!= null)
      ...
      %>
    <select name="Subject" id="Subject" style="width: 270px" onchange="getStatusOfAbsEntry();">
                                 <option value="-1">.....Select.....</option>
                                           ...
                                           int count=SubList.size();
                                            ...
                                            %>
                                           <option <%if(Integer.parseInt(absentee.getSubject())==Integer.parseInt(sub.SubBranchId)) { out.print("selected");}%>
