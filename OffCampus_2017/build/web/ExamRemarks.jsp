            ...
            int year=Integer.parseInt(PersonalData.get("AttendingYear"));
             ...
             Connection con=DBcon.getConnection();
              ...
              String Remarks = request.getParameter("Remarks");
                ...
                response.sendRedirect(response.encodeRedirectURL("Examregistration.jsp?search_button=ok"));
...
<div class="textblack"></div>	</td>
        <td bgcolor="#f9fbff">&nbsp;
         <%-- Content --%>
        <center>
            <form id="ExamRemarks" name="ExamRemarks" action="ExamRemarks.jsp" method="post">
                <input type="hidden" name="BranchId" id="BranchId" value="<%=branchId %>">
                 <input type="hidden" name="StudentId" id="StudentId" value="<%=sid %>">
               
                                <fieldset style="width:90%"><legend class="textblack"><b>Remarks <a href="Examregistration.jsp?search_button=ok" style="cursor:pointer;color: green">[Back]</a></b></legend>
