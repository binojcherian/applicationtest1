                                ...
                                <td colspan="3" align="center" class="textblack">
                                    <table border="1"  width="100%" style="border-style: groove; " cellspacing="0" cellpadding="3" >
                                        ...
                                        <tr>
                                            ...
                                            <td class="textblack"><%if(Tab.ModerationExt.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.ModerationExt %><% } %></td>
                                            <td class="textblack"><%if(Tab.IntMin.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.IntMin %><% } %></td>
                                            <td class="textblack"><%if(Tab.InternalMark.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.InternalMark %><% } %></td>
                                            <td class="textblack"><%if(Tab.ModerationInt.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.ModerationInt %><% } %></td>
                                            <td class="textblack"><%if(Tab.PassMark.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.PassMark %><% } %></td>
                                            <td class="textblack"><%if(Tab.TotalMark.equals(" ")){ %>&nbsp;<% }else {%><%=Tab.TotalMark %><% } %></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="textblack"><%if(mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con,Integer.toString(x)) ){%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con,x) %><% }else{IsGPassed=false; %>&nbsp; <%}%></td>
