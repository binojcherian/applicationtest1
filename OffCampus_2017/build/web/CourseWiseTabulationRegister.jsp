                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                                ...
                                                                <table   width="100%" style=" min-height: 500px;" cellspacing="0" cellpadding="3" >
                                                                    ...
                                                                    <%
                                                                     ...
                                                                     // ArrayList<Entity.StudentData> StudentList = mark.getStudentsOfCourse();
                                                                       ArrayList<Entity.StudentData> StudentList = mark.getStudentsOfCourseConsolidate();
                                                                            //ArrayList<Entity.StudentData> StudentList = mark.getStudentsOfCourse_BcomPartII();  
                                                                            int count = StudentList.size();
                                                                        int i = 0;
                                                                      //mba int mbacount = 1000;
                                                                        if (count > 0) {
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <table align="center" width="100%" >
                                                                             ...
                                                                             //if (((i + 1) % var == 0 || (!Student.CollegeId.equals(PrevCentre))) && i > 1)%>
                                                                                ...
                                                                                <div class="break" ></div><% }%>
                                                                                    <tr>
                                                                                       <!-- <td align="left" class="textblack" style="background-color: silver" ><b><!--%=mbacount + 1%>. Name :</b><!--%=Student.StudentName%></td>-->
                                                                                      ...
                                                                                      <td align="left" class="textblack"><b>Exam :</b>April 2014<b> </b></td>
                                                                                         <!--  <td align="left" class="textblack"><b>Exam :</b>April 2015</td>-->
                                                                                        
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="left" class="textblack" style="background-color: silver"><b>PRN :</b><%=Student.PRN%></td>

                                                                                        <td align="left" class="textblack"><b><%=mark.YearOrSem()%> :</b><%=mark.getSemYear()%><%if (mark.IsBettermentStudent(Integer.parseInt(Student.StudentId), con)) {%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><i>Betterment Exam </i></b><% } else {%>&nbsp; <%}%></td>
                                                                                            ...
                                                                                            <table border="1"  width="100%" style="border-style: groove; " cellspacing="0" cellpadding="3" >
                                                                                             ...
                                                                                             <!-- <td class="textblack" colspan="1"><div align="center">Practical </div></td>-->
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <!--<td class="textblack"><div align="center">Grace</div></td> -->
                                                                                                    <td class="textblack"><div align="center">Min</div></td>
                                                                                                    <td class="textblack"><div align="center">Mark</div></td>
                                                                                                    <td class="textblack"><div align="center">Mod</div></td>                                                                                                    
                                                                                                ...
                                                                                                <tr>
                                                                                                    ...
                                                                                                    <% if (Tab.SubjectBranchId.equals("478") ) {%>
                                                                                                     <td class="textblack"><%if (Tab.ExternalMark.equals(" ")) {%>&nbsp;<% }else if  (Tab.ExternalMark.equals("0")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ExternalMark%></font><% }%></td>
                                                                                                      <% }else{%>                                         
                                                                                                    ...
                                                                                                    <!--<td class="textblack"><%if (Tab.ExternalGraceMark.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.ExternalGraceMark%></font><% }%></td>-->
                                                                                                    <td class="textblack"><%if (Tab.IntMin.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.IntMin%></font><% }%></td>
                                                                                                    <% if (Tab.SubjectBranchId.equals("327") || Tab.SubjectBranchId.equals("351") || Tab.SubjectBranchId.equals("370") || Tab.SubjectBranchId.equals("389")|| Tab.SubjectBranchId.equals("408") || Tab.SubjectBranchId.equals("427")|| Tab.SubjectBranchId.equals("867") || Tab.SubjectBranchId.equals("875")|| Tab.SubjectBranchId.equals("884") || Tab.SubjectBranchId.equals("885")|| Tab.SubjectBranchId.equals("888") || Tab.SubjectBranchId.equals("891")) {%>
                                                                                                     <td class="textblack"><%if (Tab.InternalMark.equals(" ")) {%>&nbsp;<% }else if  (Tab.InternalMark.equals("0")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.InternalMark%></font><% }%></td>
                                                                                                      <% }else{%> 
                                                                                                   ...
                                                                                                   <!-- <td class="textblack"><%if (Tab.InternalGraceMark.equals(" ")) {%>&nbsp;<% } else {%><font style="font-weight:<%=fontstyle%>"><%=Tab.InternalGraceMark%></font><% }%></td>-->
                                                                                                    <%  Syllabus=mark.getSyllabusofSubject(Tab.SubjectBranchId); %>
                                                                                                    <% if (Tab.SubjectBranchId.equals("608") || Tab.SubjectBranchId.equals("607") || Tab.SubjectBranchId.equals("605") || Tab.SubjectBranchId.equals("610")|| Tab.SubjectBranchId.equals("611") || Tab.SubjectBranchId.equals("609")|| Tab.SubjectBranchId.equals("614") || Tab.SubjectBranchId.equals("613")|| Tab.SubjectBranchId.equals("612") || Tab.SubjectBranchId.equals("617")|| Tab.SubjectBranchId.equals("616") || Tab.SubjectBranchId.equals("615")|| Tab.SubjectBranchId.equals("452") || Tab.SubjectBranchId.equals("453")|| Tab.SubjectBranchId.equals("454") || Tab.SubjectBranchId.equals("455")) {%>
                                                 ...
                                                 IsGPassed = false;%>&nbsp;<% }%></td>
                                                                         ...
                                                                         <%if (mark.getSemYear().equals("2")) {
                                                                            if (Student.BranchId.equals("7") || Student.BranchId.equals("8")) {%>
                                                                        ...
                                                                        }%><%  // mba -mbacount=mbacount+1;
                                                                       }%>
                                                                                                <!-- NEW CODE FOR DISPLAYING SEM TOTALS FOR MCOM--->
                                                                                               <% int GTotal = 0;
                                                                                                                              
                                                                                                                             // if(mark.getSemYear().equals("3") && mark.getBranch().equals("7")){
                                                                                                                               if (mark.getSemYear().equals("4")) {
                                                                                             ...
                                                                                             <tr>
                                                                                                 ...
                                                                                                 <%--    <td class="textblack"><%if (mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con, Integer.toString(x)) && mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x)%><% } else {  IsGPassed = false;%>&nbsp; <%}%> </td> --%>

                                                                                                    
                                                                                                    <td class="textblack"><%if (mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x)%><% } else {
                                                                                                        
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                                                    <%String maxExam=mark.getSemmaxExam(Integer.parseInt(Student.StudentId), con, x);%>
            <%--  <td class="textblack"><%if (mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con, Integer.toString(x)) && mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%if(maxExam.equals("1")){%>Exam 2011<% }else if(maxExam.equals("2")){%>Exam 2012<% }else if(maxExam.equals("3")){%>Exam 2013<% }else if(maxExam.equals("4")){%>Exam 2014<% }else if(maxExam.equals("5")){%>Exam 2015<% }else if(maxExam.equals("6")){%>Exam 2016<% }else if(maxExam.equals("7")){%>Exam 2017<% }else if(maxExam.equals("8")){%>Exam 2018<% }else if(maxExam.equals("10")){%>Exam 2019<% }} else {
                                                                                                        
                                                IsGPassed = false;%>&nbsp; <%}%></td>--%>
                                   <td class="textblack"><%if ( mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%if(maxExam.equals("1")){%>Exam 2011<% }else if(maxExam.equals("2")){%>Exam 2012<% }else if(maxExam.equals("3")){%>Exam 2013<% }else if(maxExam.equals("4")){%>Exam 2014<% }else if(maxExam.equals("5")){%>Exam 2015<% }else if(maxExam.equals("6")){%>Exam 2016<% }else if(maxExam.equals("7")){%>Exam 2017<% }else if(maxExam.equals("8")){%>Exam 2018<% }else if(maxExam.equals("10")){%>Exam 2019<% }} else {
                                                ...
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                                               ...
                                                                                               <tr>
                                                                                                    ...
                                                                                                    <!--Eng -- <td class="textblack"><%if (IsGPassed) {if (GTotal> 1759 ) {%> First Class with Distinction <%}else if (GTotal< 1760 && GTotal>1319){%>First Class<%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                                   <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 1874 ) {%> Distinction  <%}else if (GTotal< 1875 && GTotal>1499){%>First Class<%}else if (GTotal > 1249 ){%>Second Class<%}}%></td>-->
                                                                                                    
                                                                                                   <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 899 ) {%> First Class  <%}else if (GTotal > 749 ){%>Second Class<%}}%></td>-->
                                                                                               
                                                                                                    <!--MCA-->
                                                                                                    <!--<td class="textblack"><%if (IsGPassed) {if(Syllabus==2010){if (GTotal> 2924 ) {%> First Class with Distinction <%}else if (GTotal< 2925 && GTotal>2339){%>First Class<%}else if (GTotal > 1949 ){%>Second Class<%}}else{ if (GTotal> 2999 ) {%> First Class with Distinction <%}else if (GTotal< 3000 && GTotal>2399){%>First Class<%}else if (GTotal > 1999 ){%>Second Class<%}}}%></td>-->
                                                                                                    <!--MCA-->
                                                                                             <td class="textblack"><%if (IsGPassed) {if(Syllabus==2010){if (GTotal> 2219 ) {%> First Class  <%}else if (GTotal > 1849 ){%>Second Class<%}}else{if (GTotal> 1919 ) {%> First Class  <%}else if (GTotal > 1599 ){%>Second Class<%}}}%></td>
                                                                                            <!--MSc MAths-->
                                                                                            <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 1319 ) {%> First Class  <%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                            <!--MSc MAths-->
                                                                                                <!--MCom,MA Sociology,MA Eng-->
                                                                                                    <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 1759 ) {%> Distinction  <%}else if (GTotal< 1760 && GTotal>1319){%>First Class<%}else if (GTotal< 1320 && GTotal>1099){%>Second Class<%}else if (GTotal > 879 ){%>Third Class<%}}%></td>-->
                                                                                                    <!--MCom-->
                                                                                                    <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 2074 ) {%> Distinction  <%}else if (GTotal< 1740 && GTotal>1450){%>First Class<%}else if (GTotal > 1160 ){%>Second Class<%}}%></td>-->
                                                                                                 <!--MSc IT-->   
                                                                                               <!--<td class="textblack"><%if (IsGPassed) {if (GTotal> 1499 ) {%> First Class  <%}else if (GTotal > 1249 ){%>Second Class<%}}%></td>-->
                                                                                               <!--MSc IT-->
                                                                                                <!--BBA<td class="textblack"><%if (IsGPassed) {if (GTotal> 2174 ) {%> Distinction  <%}else if (GTotal< 2075 && GTotal>1739){%>First Class<%}else if (GTotal > 1449 ){%>Second Class<%}}%></td>-->
                                                                                              <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 1274 ) {%> First Class with Distinction <%}else if (GTotal< 1275 && GTotal>1019){%>First Class<%}else if (GTotal< 1020 && GTotal>848){%>Second Class<%}else if (GTotal > 679 ){%>Third Class<%}}%></td>-->
                                                                                              <!-- <td class="textblack"><%if (IsGPassed) {if (GTotal> 2624 ) {%> First Class with Distinction  <%}else if (GTotal< 2625 && GTotal>2099){%>First Class<%}else if (GTotal > 1749 ){%>Second Class<%}}%></td>-->
                                                                                               </tr>
                                   ...
                                   <!--<tr>
                                                                                                  <td class="textblack" colspan="11" align="right">Grand Total</td>
                                                                                                    <td class="textblack"><%if(mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con,Integer.toString(3)) ) { if (Status == null){%>
                                                                                                        <%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con,3 )%><% }} else {
                                                IsGPassed = false;%>&nbsp; <%}%></td>
