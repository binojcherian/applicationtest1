...
if(request.getParameter("Id")==null || request.getParameter("Id").isEmpty())
    {
response.sendRedirect("UserCourseMapping.jsp");
}
...
User User=new User();
User=Map.getAssignedCourseRowToDelete(Id);
String branch=User.branchDisplay;
String SO=User.UserName;
if(request.getParameter("No")!=null && request.getParameter("No").equals("No"))
    {
    response.sendRedirect("UserCourseMapping.jsp?AV=1");
    }
if(request.getParameter("submit")!=null && request.getParameter("submit").equals("Yes"))
    {
    if(Map.RemoveCourseFromUser(request.getParameter("Id")))
        {
        response.sendRedirect("UserCourseMapping.jsp?AV=1");
        }
    }
...
<div class="textblack"></div>	</td>
        <td bgcolor="#ffffff">&nbsp;
            <%-- Content --%>
            <form id="DeleteCoursesofUsers" name="DeleteCoursesofUsers" action="DeleteCoursesofUsers.jsp" method="post">
                <input type="hidden" id="Id" name="Id" value="<%=Id %>"
                <center>
                    <table  border="1" width="80%" >
                    <tr  align="center">
                        <td height="20px" bgcolor="#d9bf79" > <b> <font color="#a02a28">Delete Course</font></b></td>
                    </tr>

                    <tr><td colspan="2">
                  <fieldset ><legend><span style="color:#a02a28; font-size: small"><b>Delete Course</b></span></legend>
                   <table>
                    ...
                    <tr>
                     ...
                     <tr>
                        ...
                        <td>
                            <input type="text" id="Course" name="Course" readonly="true" value="<%=branch %>" maxlength="30" style="width:215 px">
                        </td>
                    </tr>
                    <tr>
                        <td><font color="#a02a28">Do you want to delete this Course from the user?</font></td>
                        <td>
