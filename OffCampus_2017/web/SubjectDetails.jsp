...
<div id="SubjectCount">
                                    <%
                                        ...
                                        int TotalCount=0,AbsCount=0,MalCount=0,AbsEntered=0,MalEntered=0,MarkEntered=0,AbsWithOutFee=0,Unconfirmed=0,Pending=0;
                                        if(request.getParameter("Subject")!=null && (!request.getParameter("Subject").equals("-1")))
                                        {
                                            ...
                                            AbsenteesEntry abs=new AbsenteesEntry(request, response);
                                            ...
                                            Unconfirmed=absent.getTotalCountOfUnconfirmedStudents(request.getParameter("Subject"));
                                            Pending=absent.getTotalCountOfUnconfirmedStudentsPending(request.getParameter("Subject"));
                                            String SubjectName=mark.getSubjectNameFromSubjectBranchId();
                                        }
                                    %>
                                 <table width="100%" >
                                 <tr>
                                     <td colspan="3" class="textblack" bgcolor="#d4c7a4" align="center" height="25px" width="100%"><b>Count</b></td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="textblack"><%if(request.getParameter("Subject")!=null){ %><a href="SubjectWisePRN.jsp?SubjectBranchId=<%=request.getParameter("Subject") %>"> <%=TotalCount %></a><% }else{%><%=TotalCount %><% } %></td>
                                        ...
                                        <tr>
                                             <td class="textblack">MalPractice</td>
