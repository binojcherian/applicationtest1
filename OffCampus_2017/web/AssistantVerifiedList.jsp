...
<% if (message != null) {%>
                ...
                <td class="textblack">  The Marks approved by SO are shown in this colour</td></tr>
                        ...
                        <td class="textblack" align="left" ><%=rsPagination.getDouble("InternalMark") %></td>
                         <td class="textblack" align="left" ><%=rsPagination.getDouble("PracticalMark") %></td>
                        <td class="textblack" align="left" ><%=rsPagination.getDouble("ExternalMark")+ rsPagination.getDouble("InternalMark")+ rsPagination.getDouble("PracticalMark")%></td>
                    </tr>
