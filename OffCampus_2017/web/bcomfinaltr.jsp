                                            ...
                                            <tbody><tr>
                                                ...
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                               ...
                                                                               <!--  <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><%if (mark.IsStudentPassedForBcomPartIII(Integer.parseInt(Student.StudentId), con,2) ) {%>
                                                                                                        <%=mark.getSemTotalofBcomPartIII(Integer.parseInt(Student.StudentId), con,2 )%><% } else {
                                                IsGPassed = false;%>&nbsp; <%}%></td>
<td class="textblack"><%if (mark.IsStudentPassedForBcomPartIII(Integer.parseInt(Student.StudentId), con,2) ) {t=mark.getSemTotalofBcomPartIII(Integer.parseInt(Student.StudentId), con,2 );%>
    <%if (Integer.parseInt(t)> 839 ) {%>First Class <%}else if (Integer.parseInt(t)< 839 && Integer.parseInt(t)>699){%>Second Class<%}else if (Integer.parseInt(t)< 700 ){%>Third Class<%}}%></td>
                                                                                  </tr>
