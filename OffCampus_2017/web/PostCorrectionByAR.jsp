...
%>
            <form id="PostCorrectionAR" name="PostCorrectionAR" action="PostCorrectionByAR.jsp" method="post">

                <center>
                    <table  border="1" width="98%" >
                    <tr  align="center">
                        <td height="20px" bgcolor="#d9bf79" colspan="3" > <b> <font color="#a02a28"> Post Correction By AR</font></b></td>
                    </tr>
                    <tr>
                        <td>
                            <fieldset><legend><span style="color:#a02a28; font-size: small"><b> List of Marks</b></span></legend>
                                ...
                                <td align="left">
                                 ...
                                 %>
                                        ...
                                        <td class="textblack" align="left">
                                            <select name="SO" id="SO" style="width: 215px" >
                                            <option value="-1">.....Select.....</option>
                                            <% ArrayList<User> UserList=mark.getAllSO();
                                            i=0;
                                            if(UserList!=null)
                                                {
                                            count=UserList.size();
                                            ...
                                            %>
                                           <option <%if(mark.getSO().equals(us.UserName)) { out.print("selected");}%>
                                    ...
                                    <center>
                                        <font class="textblack" color="#a02a28"><b>
                                                <%if(request.getParameter("SO")!=null && (!request.getParameter("SO").equals("-1"))){ %>
                                                Total Records Verified by <%= request.getParameter("SO")%>: <%=mark.getTotalCountOfRecordsToBeVerifiedByAR() %><% } else{%>
                                                <div id="recordCount"></div><% }%>
                                            </b></font>
                                        <br>
                                         <%
                    ArrayList<StudentSubjectMark> StudentList=new ArrayList<StudentSubjectMark>();
                    StudentList=mark.getPostCorrectionByAR();
                    ...
                    if(Count==0)
                     ...
                     <table border="1" width="98%" style="border-style: groove" cellspacing="0" cellpadding="3">
                         <tr class="textblack"  align="center"><span style="color:#a02a28; font-size: small"><b>Total number of Records to be verified : <%=mark.getTotalCountOfRecordsToBeVerifiedByAR() %></b></span></tr>
                    ...
                    <tr id="MarkList" name="MarkList">
                        ...
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="external" name="external" value="<%=stu.ExternalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);" onblur="CalculateInternalForVerificationPostCorrectionAR(<%=i%>);"></td>
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="internal" name="internal" value="<%=stu.InternalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);"></td>
                         ...
                         <td class="textblack" align="left"><input type="button" name="SubmitEdit" id="SubmitEdit" value="Edit" onclick="return OpenTextForEditPostCorrectionByAR(<%=i%>);" </td>
                    </tr>
                    <input type="hidden" id="SubjectBranchId" name="SubjectBranchId" value="<%=stu.SubjectBranchId %>">
                    <% i++;}%>
                     <tr>
                         <td colspan="11"class="textblack" align="left"><input type="checkbox" name="SelectAll"id="SelectAll" Value="SelectAll" onclick="SelectAllRowsPostCorrectionByAR(this.form);"><b>SelectAll</b> </td>
                    </tr>
                    <tr>
