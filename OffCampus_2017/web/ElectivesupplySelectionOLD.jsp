    ...
    if(subBranch=="-1")
        {
            ...
            if(BranchId==24 || BranchId==25 ||   BranchId==27 || BranchId==28 || BranchId==29 || BranchId==30 ||BranchId==31)
            {
                 var list=document.getElementsByName("ImproveList");
                 var selectedCount=0;
                ...
                if(selectedCount>2){
                 ...
                 alert("You can select only 2 improvement papers");
             return false;
         }
            }
return true;
