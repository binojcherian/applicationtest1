...
<div class="textblack"></div>	</td>
    ...
    <br>
    <div align="justify">
        <h4><u>Instruction</u></h4><p>
        Step I: User Management ( give user name and password for all the users in Offcampus Section(Exam) )<p>
        Step II: Assign each assistants to the corresponding SO<p>
            Step III: Add the total number of absent/Malpractice students, corresponding to the subject.<p>
            For doing all the above steps, please click the <a href="UserCreation.jsp">Exam Management</a> menu<P>
            <font color="red"> Systematic convensions and approaches to be strictly followed.</font> <p>
       <h5> NB: Without entering the count of absent/Malpractice students the system cannot move further.  </h5>
