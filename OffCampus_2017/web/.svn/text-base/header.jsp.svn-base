<%-- 
    Document   : header
    Created on : Jun 9, 2011, 11:51:24 AM
    Author     : mgu
--%>
...
<tr align="right" ><td align="right"  style="color:#6c4303"><a href="Instructions.jsp" >Home</a> |  <a href="UserCreation.jsp" >Exam Management</a> |  <a href="Support.jsp" >Support</a> |   <a href="/OffCampus/Logout" >Logout</a>
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr valign="top" align="left">
    <td height="7" width="100%" bgcolor="#a02a28"><img src="images/spacer.gif" alt=""></td>
  </tr>
