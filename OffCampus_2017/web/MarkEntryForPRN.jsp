<%--
    ...
    Author     : user
--%>
<%@page contentType="text/html" pageEncoding="UTF-8" language="java" errorPage="ErrorPage.jsp" import="Controller.*,java.util.ArrayList,Entity.*"%>
<%
...
<center>
                       ...
                       <tr>
                        ...
                        <% } %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="PRN" id="PRN" value="<%=mark.getPRN() %>" style="width: 215px" maxlength="13" onblur="CalculateExternal();">
                                </td>
                        ...
                        <% } %>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="InternalMark" id="InternalMark" readonly="true" value="<%=mark.getInternalMark() %>" style="width: 115px" maxlength="3" onkeypress="return chkNumForInt(event);">
                                ...
                                <%if(mark.InternalError()!=null) {%>
                        <td><span style="color:#a02a28; font-size: small"><%=mark.InternalError()%></span> </td>
                        <% } %>
                            </tr>
                             <tr>
                                <td class="textblack">Practical Mark</td>
                                <td>
                                    <input type="text" name="PracticalMark" id="PracticalMark" readonly="true" value="<%=mark.getPracticalMark()%>" style="width: 115px" maxlength="2" onkeypress="return chkNumForInt(event);">
                                    <input type="Submit" name="btnEdit" id="PbtnEdit" value="Enable"   onclick="return EnableEditForPractical();">
                                    <input type="hidden" name="PracticalEdit" id="PracticalEdit" value="">
                                </td>
                                <%if(mark.PracticalError()!=null) {%>
                        <td><span style="color:#a02a28; font-size: small"><%=mark.PracticalError()%></span> </td>
                        <% } %>
                            </tr>
                            ...
                            <tr>
                                <td class="textblack" colspan="2" align="right">
                                   ...
                                   <input type="submit" name="Submit" id="Submit" value="Submit" <%if(CountMark >=20)
                                                                           ...
                                                                           <% }else{%>><%}%> <% }%>
                                    <input type="button" name="Submit" id="Submit" value="Reset" onclick="return ResetAll();">
                                </td>
                            </tr>
                                     ...
                                     <td colspan="3" class="textblack" bgcolor="#d4c7a4" align="center" height="25px" width="100%"><b>Count</b></td>
                                        ...
                                        -->
                                         <tr>
                                             ...
                                             <td class="textblack" style="color:#a02a28;font-weight:bold;text-align: center;"><%=totalentered %></td>
                                        </tr>
                                        </table>
                                        </tr>
                                    </table>
                   ...
                   <table border="1" width="100%" style="border-style: groove" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                        ...
                        <td class="textblack"><%=stu.PracticalMark %></td>
                        <%if(stu.ExternalMark!=null){ %>
                        <td class="textblack"><%=Double.parseDouble(stu.ExternalMark)+ Double.parseDouble(stu.InternalMark)+Double.parseDouble(stu.PracticalMark)%></td><%}%>
