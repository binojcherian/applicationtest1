<%-- 
    Document   : Header_Registration
    Created on : Apr 6, 2012, 2:02:21 PM
    Author     : user
--%>
...
if(Role==35)
    {
    ExamPage="MarkCorrectionSuperAdmin.jsp";
...
<tr align="right" ><td align="right"  style="color:#6c4303"><a href="<%=InstructionPage %>" >Home</a> | <a href="Examregistration.jsp" >Exam Registration</a> |  <a href="<%=ExamPage %>" >Exam Management</a> |  <a href="Support.jsp" >Support</a> | <a href="/OffCampus/Logout" >Logout</a>
<table width="100%" align="center" border="0" cellpadding="0" cellspacing="0">
  <tbody><tr valign="top" align="left">
    <td height="7" width="100%" bgcolor="#a02a28"><img src="images/spacer.gif" alt=""></td>
  </tr>
