...
%>
            <form id="RevaluationByAR" name="RevaluationByAR" action="RevaluationByAR.jsp" method="post">

                <center>
                    <table  border="1" width="98%" >
                    <tr  align="center">
                        <td height="20px" bgcolor="#d9bf79" colspan="3" > <b> <font color="#a02a28"> Revaluation By AR</font></b></td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr id="MarkList" name="MarkList">
                        ...
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="external" name="external" value="<%=stu.ExternalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);" onblur="CalculateInternalForVerificationRevaluationAR(<%=i%>);"></td>
                        <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="internal" name="internal" value="<%=stu.InternalMark %>" readonly="true"  style="width:100%;" onkeypress="return chkNum(event);"></td>
                         ...
                         <td class="textblack" align="left"><input type="button" name="SubmitEdit" id="SubmitEdit" value="Edit" onclick="return OpenTextForEditRevaluationByAR(<%=i%>);" </td>
                    </tr>
                    <input type="hidden" id="SubjectBranchId" name="SubjectBranchId" value="<%=stu.SubjectBranchId %>">
                    <% i++;}%>
                     <tr>
                         <td colspan="11"class="textblack" align="left"><input type="checkbox" name="SelectAll"id="SelectAll" Value="SelectAll" onclick="SelectAllRowsRevaluationByAR(this.form);"><b>SelectAll</b> </td>
                    </tr>
                    <tr>
