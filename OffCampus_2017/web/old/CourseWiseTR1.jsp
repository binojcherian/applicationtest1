...
<tr><td>
    <table width="95%" align="center" border="0" cellpadding="0" cellspacing="0" >
     ...
     <tr>
         <td></td>
          <td align="center" >
              <font size="2px">Tabulation Register of <%=" "+Year+""+Sem+ " "+examconfirm.getCourseName(request.getParameter("Course"), con)+ " "%>Off Campus Examination April-2011</font>
         </td>
     </tr>
     <tr>
         <td align="left" class="textblack" colspan="2"><b> Centre:</b><%= Student.get(0).Centre%>  &nbsp;</td>
     </tr>
     ...
     <center>
                                            <table width="100%" border="1" style="border-color: gray " cellpadding="3" cellspacing="0" >
                                                ...
                                                %>
                                                 ...
                                                 <div <%if(Stuindex%7==0 && Stuindex>1 ||( stucenter!=null && !stucenter.equals(stu.Centre))){%>class=break<% }%>/>
                                                <%
                                                if(Stuindex%7==0 && Stuindex>1 ||( stucenter!=null && !stucenter.equals(stu.Centre)))
                                                    {

                                                    
                                                %>
                                                <tr>
                                                    <td class="textforprint" colspan="<%=SubCount+6 %>" >
                                                        <table width="100%">
                                                            <tr >
                                                                <td class="textblack">Assistant:</td>
                                                                <td class="textblack">SO:</td>
                                                                <td class="textblack">AR:</td>
                                                                <td class="textblack">JR:</td>
                                                                <td class="textblack">CE:</td>
                                                            </tr>
                                                            <tr><td>
            &nbsp;
         </td></tr>
         ...
         <td align="left " class="textblack" colspan="2"><b> Centre:</b><%=stu.Centre %>&nbsp;</td>
                                                    ...
                                                    <%
                                                        ...
                                                        while (i < SubCount) {
                                                            Subject sub = SubList.get(i);
                                                    %>
                                                    <td  class="textforprint" style="width:30px" ><%=sub.SubjectName%></td>
                                                    <% i++;}%>
                                                    <td rowspan="3" align="center" width="40px"class="textforprint">Grand Total</td>
                                                    <td rowspan="3" align="center" width="40px"class="textforprint">Pass/Fail</td>
                                                    <td rowspan="3" align="center" width="100px"class="textforprint">Remarks</td>
                                                ...
                                                <tr >
                                                    <td class="textforprint" rowspan="6"><%=stu.PRN%></td>
                                                    <td class="textforprint" rowspan="6"><%=stu.Name.toUpperCase()%></td>
                                                    <td class="textforprint">Ext</td>
