        ...
        <tbody><tr valign="top" align="left">
                <td width="100%">
                    <table width="100%" bgcolor="#ffffff" border="0" cellpadding="0" cellspacing="0">
                                             ...
                                             <% String stucenter=null;
                                                ...
                                                <center>
                                                 <table width="100%" cellpadding="0"  >
                                                     <tr>
                                                      <div <%if(Stuindex%5==0 && Stuindex>1 ||( stucenter!=null && !stucenter.equals(stu.Centre))){%>class=break<% }%>>

                                                    <%if((Stuindex)%5==0 ||( stucenter!=null && !stucenter.equals(stu.Centre))){%>
                                                ...
                                                <tr >
                                                    ...
                                                    <td width="25"  class="textforprint">&nbsp;</td>
                                                    ...
                                                    %>
                                                    <td  class="textforprint" style="width:25" ><%=sub.SubjectName%></td>
                                                    <% i++;}%>
                                                    <td rowspan="3" align="center" width="35"class="textforprint">Grand Total</td>
                                                    <td rowspan="3" align="center" width="35"class="textforprint">Pass/Fail</td>
                                                    <td rowspan="3" align="center" width="35"class="textforprint">Remarks</td>
                                                </tr>
                                                <tr>
                                                    <td class="textforprint">Max</td>
                                                    <%
                                                        i = 0; String Max="",Min="";
                                                        while (i < SubCount) {
                                                ...
                                                <tr>
                                                    ...
                                                    <% i++; }%>
                                                     ...
                                                     </table></tr></table><%}%></div></tr>
                                                     <!--Mark Listing Starts here-->
                                                     <tr>
                                                     <table width="100%" border="1" style="border-color: gray " cellpadding="3" cellspacing="0">
                                                         <tr>
                                                             <td class="textforprint" colspan="2"><b><%=stu.PRN %></b></td>
                                                             <td class="textforprint" colspan="8"><b><%=stu.Name.toUpperCase() %></b></td>
                                                         </tr>
                                                         <tr>
                                                         <table width="100%" border="1" style="border-color: gray " cellpadding="3" cellspacing="0">
                                                                <tr >

                                                    <td class="textforprint" width="35" >Ext</td>
                                                    <% String Total=" ";String Status=" ";boolean IsStudent=false;String str=" "; boolean flag=true;;
                                                    for (i = 0; i < MarksCount; i++) {
                                                                                         ...
                                                                                         if (Tab.StudentId.equals(st.toString())) {
                                                                                             ...
                                                                                             if(str!=null)
                                                                                                ...
                                                                                                IsStudent=true;
                     %>
                     <td class="textforprint" align="center"><% if(Tab.ExternalMark!=null){ %><%=Tab.ExternalMark%><%}else{%> &nbsp;<% }%></td><% }
                                                  } if(IsStudent){ %>
                                                  <td class="textforprint" rowspan="6" valign="bottom"><b><%if(Total==null ||(!flag)){%>&nbsp; <% }else {%><%=Total %><%}%></b></td>
                                                  <td class="textforprint" rowspan="6" valign="bottom"><b><%=Status %></b></td><% }%>
                                                  <td class="textforprint" rowspan="6">&nbsp;</td> </tr>

                                                <tr>
                                                    <td class="textforprint" width="35" >Mod Ext</td>
                                                    <% for (i = 0; i < MarksCount; i++) {
                                                                                         Integer st = stu.StudentId;
                                                                                         TabulationData Tab = TabData.get(i);
                                                                                         if (Tab.StudentId.equals(st.toString())) {%>
                                                    <td class="textforprint" align="center"><%if (Tab.ModerationExt.equals(" ")) {%>&nbsp;<% } else {%><%=Tab.ModerationExt%><%}%></td><% }
                                          }%>
                                                </tr>
                                                <tr>
                                                    <td class="textforprint" width="35" >Int</td>
                                                    <% for (i = 0; i < MarksCount; i++) {
                                                                                         Integer st = stu.StudentId;
                                                                                         TabulationData Tab = TabData.get(i);
                                                                                         if (Tab.StudentId.equals(st.toString())) {%>
                                                    <td class="textforprint" align="center"><%if (Tab.InternalMark.equals(" ")) {%>&nbsp;<% } else {%><%=Tab.InternalMark%><%}%></td><% }
                                          }%>
                                                </tr>
                                                <tr>
                                                    <td class="textforprint" width="35" >Mod Int</td>
                                                    <% for (i = 0; i < MarksCount; i++) {
                                                                                         Integer st = stu.StudentId;
                                                                                         TabulationData Tab = TabData.get(i);
                                                                                         if (Tab.StudentId.equals(st.toString())) {%>
                                                    <td class="textforprint" align="center"><%if (Tab.ModerationInt.equals(" ")) {%>&nbsp;<% } else {%><%=Tab.ModerationInt%><%}%></td><% }
                                          }%>
                                                </tr>
                                                <tr >

                                                    <td class="textforprint" width="35" ><b>Total</b></td>
                                                    <% for (i = 0; i < MarksCount; i++) {
                                                                                         Integer st = stu.StudentId;
                                                                                         TabulationData Tab = TabData.get(i);
                                                                                         if (Tab.StudentId.equals(st.toString())) {
                     ...
                     %>
                                                    <td class="textforprint" align="center"><b><%if (Tot.equals(" ")) {%>&nbsp;<% } else {%><%=Tot%><%}%></b></td><% }
                                          }%>
