        ...
        <table width="90%" align="center" border="0" cellpadding="0" cellspacing="0">
            <tbody>
                                            ...
                                            <tbody><tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td bgcolor="#ffffff">&nbsp;
                                                        ...
                                                        %>
                                                        <form id="MarkCorrectionAdmin" name="MarkCorrectionAdmin" action="MarkCorrectionAdmin.jsp" method="post">

                                                            <center>
                                                                <table  border="1" width="98%" >
                                                                    <tr  align="center">
                                                                        <td height="20px" bgcolor="#d9bf79" colspan="3" > <b> <font color="#a02a28"> MarkCorrectionAdmin</font></b></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td>
                                                                                ...
                                                                                <center>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left">
                                                                                                    <select name="Exam" id="Exam" style="width: 250px">
                                                                                                        ...
                                                                                                        %>
                                                                                                        <option <%if (mark.getExam().equals(exam.ExamId)) {
                                                                                                                out.print("selected");
                                                                                                            }%>
                                                                                                ...
                                                                                                <td align="left">
                                                                                                    <div id="Acdemic_Year" align="left">
                                                                                                        <select  name="AcdemicYear" id="AcdemicYear" style="width: 115px">
                                                                                                            <option value="-1">.....Select.....</option>
                                                                                                                    <option value="2010" <%if (mark.getAcademicYear().equals("2010")) {
                                                                                                                    out.print("selected");
                                                                                                                }%>>2010</option>
                                                                                                                    <option value="2011" <%if (mark.getAcademicYear().equals("2011")) {
                                                                                                                    out.print("selected");
                                                                                                                }%>>2011</option>
                                                                                                                    <option value="2012" <%if (mark.getAcademicYear().equals("2012")) {
                                                                                                                    out.print("selected");
                                                                                                                }%>>2012</option>
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    ...
                                                                                                    <div id="YearOrSem" align="left">
                                                                                                        <select  name="YearSem" id="YearSem" style="width: 115px" onchange="ChangeSubjectListNew();">
                                                                                                            ...
                                                                                                            <%
                                                                                                                ...
                                                                                                                i = 1;
                                                                                                                while (i <= count) {%>
                                                                                                                <option <%if (Integer.parseInt(mark.getSemYear()) == i) {
                                                                                                                    out.print("selected");
                                                                                                                }%> value=<%=i%>><%=i%></option>
                                                                                                            <% i++;
                                                                                                                }%>
                                                                                            ...
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="left">
                                                                                                    <div id="SubjectList" align="left">
                                                                                                        <select name="Subject" id="Subject" style="width: 270px">
                                                                                                            ...
                                                                                                            %>
                                                                                                            <option <%if (mark.getSubject().equals(sub.SubjectId)) {
                                                                                                                    out.print("selected");
                                                                                                                }%>
                                                                                                ...
                                                                                                <td class="textblack" align="left">
                                                                                                    <select name="Assistant" id="Assistant" style="width: 215px" >
                                                                                                        ...
                                                                                                        %>
                                                                                                        <option <%if (mark.getAssistant().equals(us.UserName)) {
                                                                                                                out.print("selected");
                                                                                                            }%>
                                                                                    ...
                                                                                    <center>
                                                                                        ...
                                                                                        <table border="1" width="100%" style="border-style: groove" cellspacing="0" cellpadding="3">
                                                                                            ...
                                                                                            %>
                                                                                                <tr id="MarkList" name="MarkList" <%if (stu.IsAbsent.equals("1")) {%> bgcolor="#dedede"<%}
                                                                                                if (stu.MarkStatus.equals("1")) {%> bgcolor="#f7f7f7"<%}%>>
                                                                                                ...
                                                                                                <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="IntMod" name="IntMod" value="<%=stu.InternalMod%>" readonly="true"  style="width:90%;" ></td>
                                                                                                 <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="ExtGrace" name="ExtGrace" value="<%=stu.gracemarkExt%>" readonly="true"  style="width:90%;" ></td>
                                                                                                <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="IntGrace" name="IntGrace" value="<%=stu.gracemarkInt%>" readonly="true"  style="width:90%;" ></td>
                                                                                                ...
                                                                                                <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="IntMod" name="IntMod" value="<%=stu.InternalMod%>" readonly="true"  style="width:90%;" onkeypress="return chkNum(event);"></td>
                                                                                                   <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="ExtGrace" name="ExtGrace" value="<%=stu.gracemarkExt%>" readonly="true"  style="width:90%;" onkeypress="return chkNum(event);"></td>
                                                                                                <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="IntGrace" name="IntGrace" value="<%=stu.gracemarkInt%>" readonly="true"  style="width:90%;" onkeypress="return chkNum(event);"></td>
                                                                                                ...
                                                                                                <td class="textblack" align="left"><%=Double.parseDouble(stu.ExternalMark) + Double.parseDouble(stu.InternalMark) + Double.parseDouble(stu.ExternalMod) + Double.parseDouble(stu.InternalMod) + Double.parseDouble(stu.ClassMod) + Double.parseDouble(stu.PracticalMark) + Double.parseDouble(stu.TourReportMark)+ Double.parseDouble(stu.gracemarkExt)+ Double.parseDouble(stu.gracemarkInt)%></td>
                                                                                                <td class="textblack" style="width:60px;"><input type="text" maxlength="5" id="Absent" name="Absent" value="<%=stu.IsAbsent%>" readonly="true"  style="width:90%;" ></td>
                                                                                            ...
                                                                                            <!-- <tr>
                                                                                               <td colspan="16"class="textblack" align="left"><input type="checkbox" name="SelectAll"id="SelectAll" Value="SelectAll" onclick="SelectAllRows(this.form);"><b>SelectAll</b> </td>
                                                                                            </tr>->
                                                                                            <!-- <tr>
                                                                                            ...
                                                                                            <% }
                                                                                                 ...
                                                                                                 <!-- edited by SCN--->
                                                                                                 <tr><td colspan="21" align="right"> <a href="#" onclick="printInfo();">Print Now</a></td></tr>
                                                                                                    <!-- edited by SCN--->
                                                                                        </table> </center>
               ...
               <script>
                function printInfo()
                {
                  var  exam="",course="",prn="",academic="",yearsem="",subject="",assistant=""; 
                  exam=document.getElementById("Exam").value;
                  course=document.getElementById("Course").value;
                  prn=document.getElementById("PRN").value;
                  academic=document.getElementById("AcdemicYear").value;
                  yearsem=document.getElementById("YearSem").value;
                  subject=document.getElementById("Subject").value;
                  assistant=document.getElementById("Assistant").value;
                 // alert(academic);
                   //window.location="PrintMarkCorrectionAdmin.jsp?ex="+exam+"&co="+course;
                   var orgurl = "PrintMarkCorrectionAdmin.jsp?ex="+exam+"&co="+course+"&prn="+prn+"&ac="+academic+"&year="+yearsem+"&sub="+subject+"&assi="+assistant;
                   //var encurl = encodeURI(orgurl);
