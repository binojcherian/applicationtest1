                                                                             ...
                                                                             //if (((i + 1) % var == 0 || (!Student.CollegeId.equals(PrevCentre))) && i > 1)%>
                                                                                ...
                                                                                <div class="break" ></div><% }%>
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="left" class="textblack"><b>Exam :</b>April 2014</td>
                                                                         ...
                                                                         <%if (mark.getSemYear().equals("2")) {
                                                                            if (Student.BranchId.equals("7") || Student.BranchId.equals("8")) {%>
                                                                                               ...
                                                                                               <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><%if (mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con, x) && mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x) != null) {%><%=mark.getSemTotal(Integer.parseInt(Student.StudentId), con, x)%><% } else {
                                                IsGPassed = false;%>&nbsp; <%}%></td>
                                                                                ...
                                                                                <!-- <tr>
                                                                                                    ...
                                                                                                    <td class="textblack"><%if (mark.IsStudentPassedForSemester(Integer.parseInt(Student.StudentId), con,1) ) {%>
