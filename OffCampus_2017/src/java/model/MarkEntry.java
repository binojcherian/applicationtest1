...
public String getStudentSubjectBranchId(String ExamId,int StudentId,String SubjectId,int CurrentYearSem)throws SQLException
{
    Connection con=null;
    try
        {
...
public boolean IsStudentAbsentForSubject(int StudentId,String ExamId,String BranchId,String SubjectId,int Sem,String AcdemicYear) throws SQLException
{
     Connection con=null;
        try
        {
...
public boolean IsStudentMarkAlreadyEntered(int StudentId,String SubjectId,String ExamId,String BranchId,int Sem,String AcdemicYear) throws SQLException
{
    Connection con=null;
        try
        {
...
public int getTotalCountOfRecordsToBeVerifiedBySO(String UserName) throws SQLException
{
    Connection con=null;
        ...
        {
            con=new DBConnection().getConnection();
            PreparedStatement st=con.prepareStatement("select count(*) from StudentSubjectMark m inner join MarkEntryLog l on m.StudentSubjectMarkId=l.StudentSubjectMarkId and m.ExamId=7 inner join AssistantSOMapping a on a.User_Asst=l.UserName and a.EndDate is null and l.Privilege=33 and a.User_SO=? and m.IsSOVerified=0 and IsAssistantVerified=1 and l.IsEdited=0");
            st.setString(1, UserName);
            ResultSet rs=st.executeQuery();
            if(rs.next())
            {
...
public boolean IsStudentUnconfirmedForSubject(int StudentId,String ExamId,String BranchId,String SubjectId,int Sem,String AcdemicYear) throws SQLException
{
     Connection con=null;
        try
        {
...
public boolean IsStudentRegisteredThisSubject(int StudentId,String SubjectId,String ExamId,String BranchId,int Sem,String AcdemicYear) throws SQLException
{
    Connection con=null;
        try
        {
...
public long CalculateInternal(double ExternalMark,String SubjectId,String BranchId,int Sem,String AcdemicYear) throws SQLException
{
    Connection con=null;
    long Internal;
        try
...
public boolean IsSubjectHasNoInternalCalculation(String SubjectId,String BranchId,int Sem,String AcdemicYear) throws SQLException
{
    Connection con=null;
        try
        {
...
public int getTotalCountOfStudentsForCourse_Subject(String SubjectBranchId,String ExamId) throws SQLException
{
    Connection con=null;
        try
        {
            con = new DBConnection().getConnection();
            PreparedStatement st=con.prepareStatement("Select count(distinct e.StudentId) from ExamRegistrationMaster e  where e.SubjectBranchId=? and e.ExamId=? ");
            st.setString(1,SubjectBranchId);        
            st.setString(2, ExamId);
            ResultSet rs=st.executeQuery();
            if(rs.next())
...
public int getTotalCountOfStudentsForCourse_MBA_Subject(String SubjectBranchId,String ExamId) throws SQLException
{
    Connection con=null;
        try
        {
            con = new DBConnection().getConnection();
            PreparedStatement st=con.prepareStatement("Select count(distinct e.StudentId) from ExamRegistrationMaster e "
                    ...
                    + " where s.SubjectId=? and e.ExamId=? ");
            st.setString(1,SubjectBranchId);        
            st.setString(2, ExamId);
            ResultSet rs=st.executeQuery();
            if(rs.next())
...
public ArrayList<ResultStatistics> getStatisticsForCourse(String BranchId,String Sem,String ExamId) throws SQLException
{
    ...
    Absentees abs=new Absentees();
        ...
        {
            con = new DBConnection().getConnection();
           // PreparedStatement st=con.prepareStatement("SELECT sb.SubjectBranchId,sb.SubjectCode,s.SubjectName,count(distinct StudentId) as Pass from SubjectBranchMaster sb inner join SubjectMaster s on s.SubjectId=sb.SubjectId inner join StudentSubjectMark m on sb.SubjectBranchId=m.SubjectBranchId   and m.ExamId=? where sb.BranchId=? and sb.CurrentYearSem=?  group by sb.SubjectBranchId");
            PreparedStatement st=con.prepareStatement("SELECT sb.AcademicYear,sub.SubBranchName,sb.SubjectBranchId,sb.SubjectCode,s.SubjectName,count(distinct StudentId) as Pass from SubjectBranchMaster sb " +
"inner join SubjectMaster s on s.SubjectId=sb.SubjectId inner join StudentSubjectMark m on sb.SubjectBranchId=m.SubjectBranchId   and m.ExamId=? " +
"left join SubBranchMaster sub on sub.SubBranchId=sb.SubBranchId " +
"where sb.BranchId=? and sb.CurrentYearSem=?  group by sb.SubjectBranchId " +
"order by sb.AcademicYear,sb.SubBranchId,sb.PaperNo");
           st.setString(1, ExamId);
            st.setString(2, BranchId);
            st.setString(3, Sem);
             //and IsSOVerified=1
            ...
            while(Subject.next())
            {
                ...
                Result.syllabus=Subject.getString("AcademicYear");
                 Result.SubBranchName=Subject.getString("SubBranchName");
                ...
                int totalpass=abs.getTotalCountOfStudentsForPassedSubject(Subject.getString("SubjectBranchId"), ExamId);
                int totalabsent=abs.getTotalCountOfStudentsForAbsentSubject(Subject.getString("SubjectBranchId"), ExamId);
                Result.TotalPass=totalpass;
                Result.TotalAbsent=totalabsent;
                ...
                Result.PassPercentage=Math.round((totalpass/TotalReg)*100);
                Stat.add(Result);
...
public ArrayList<ResultStatistics> getStatisticsForCourse_MBA(String BranchId,String Sem,String ExamId) throws SQLException
{
    Connection con=null;
    ArrayList<ResultStatistics> Stat=new ArrayList<ResultStatistics>();
    Absentees abs=new Absentees();
        try
        {
            con = new DBConnection().getConnection();
           // PreparedStatement st=con.prepareStatement("SELECT sb.SubjectBranchId,sb.SubjectCode,s.SubjectName,count(distinct StudentId) as Pass from SubjectBranchMaster sb inner join SubjectMaster s on s.SubjectId=sb.SubjectId inner join StudentSubjectMark m on sb.SubjectBranchId=m.SubjectBranchId   and m.ExamId=? where sb.BranchId=? and sb.CurrentYearSem=?  group by sb.SubjectBranchId");
            PreparedStatement st=con.prepareStatement("SELECT sb.AcademicYear,sub.SubBranchName,sb.SubjectBranchId,sb.SubjectCode," +
" s.SubjectId,s.SubjectName,count(distinct StudentId) as Pass from StudentSubjectMark m " +

" inner join SubjectBranchMaster sb on sb.SubjectBranchId=m.SubjectBranchId   and m.ExamId=?" +
" inner join SubjectMaster s on s.SubjectId=sb.SubjectId " +
" left join SubBranchMaster sub on sub.SubBranchId=sb.SubBranchId " +
" where sb.BranchId=? and sb.CurrentYearSem=?  group by sb.SubjectId " +
" order by sb.AcademicYear,sb.SubBranchId,sb.PaperNo");
           st.setString(1, ExamId);
            st.setString(2, BranchId);
            st.setString(3, Sem);
            ...
            while(Subject.next())
            {
                ...
                Result.SubjectCode=Subject.getString("SubjectCode");
                Result.SubjectName=Subject.getString("SubjectName");
                int totalpass=abs.getTotalCountOfStudentsForPassedSubject_MBA(Subject.getString("SubjectId"), ExamId);
                int totalabsent=abs.getTotalCountOfStudentsForAbsentSubject_MBA(Subject.getString("SubjectId"), ExamId);
                Result.TotalPass=totalpass;
                Result.TotalAbsent=totalabsent;
                int TotalReg=abs.getTotalCountOfStudentsForSubject_MBA(Subject.getString("SubjectId"), ExamId)-abs.getTotalCountOfAbsenteeForSubject_MBA(Subject.getString("SubjectId"), ExamId);
                Result.TotalReg=TotalReg;
                Result.PassPercentage=Math.round((totalpass/TotalReg)*100);
                Stat.add(Result);
...
public String getSubjectIdfromSubjectBranchId(String SubjectBranchId) throws SQLException
{
    Connection con=null;
        try
        {
            con = new DBConnection().getConnection();
            PreparedStatement st=con.prepareStatement("SELECT SubjectId FROM SubjectBranchMaster where SubjectBranchId=? ");
            st.setString(1,SubjectBranchId);
            ResultSet rs=st.executeQuery();
            if(rs.next())
            {
...
public int getSemesterTotalForCourseMCA(String BranchId,int Sem,int year) throws SQLException
{
    Connection con=null;
        try
        {
    ...
    try
    {
        while(i<=To)
        {
           ...
           // String Query="select distinct m.StudentId,sum((m.ExternalMark+m.InternalMark)-b.PassMark) as Mark from StudentSubjectMark m  inner join SubjectBranchMaster b on b.SubjectBranchId=m.SubjectBranchId  and b.BranchId=? and b.CurrentYearSem=? and m.ExamId=? and m.IsPassed=0 and m.IsValid=1 where m.IsAbsent!=1  group by StudentId  ";
             String Query="select distinct m.StudentId,sum((m.ExternalMark+m.InternalMark)-b.PassMark) as Mark from StudentSubjectMark m  inner join SubjectBranchMaster b on b.SubjectBranchId=m.SubjectBranchId  and b.BranchId=? and b.CurrentYearSem=? and m.ExamId=? and m.IsPassed=0 and m.IsValid=1  group by StudentId  ";
            con=new DBConnection().getConnection();
            PreparedStatement st=con.prepareStatement(Query);
            st.setString(1, BranchId);
            st.setString(2,Sem);
            ...
            while(Rs.next())
            {
                ...
                stat.SemPass=passbeforemod+stat.TotalPass;
                stat.PassedT=totalpass+j;
            }
            Statistics.add(stat);
            i++;
        }
...
//edited by SCN
public ArrayList<StatisticsWithModeration> getStatisticsForBranchWithModeration_edited(int From,int To, String BranchId,String Sem,String ExamId) throws SQLException
{
    ArrayList<StatisticsWithModeration> Statistics=new ArrayList<StatisticsWithModeration>();
    Connection con=null;int i=From;
    int Count=0,Reg=getTotalCountOfStudentsForCourse(BranchId, Sem, ExamId);
    int passbeforemod=getTotalPassForCourse(BranchId, Sem, ExamId);
    int totalpassed=passbeforemod;
    int totalpass=Reg-passbeforemod;
    try
    {
        while(i<=To)
        {
            ...
            while(Rs.next())
            {
                ...
                stat.PassPercentage=(stat.TotalPass*100)/Reg;
                //stat.TotalFail=totalpass-stat.TotalPass;
                stat.TotalFail=totalpassed+stat.TotalPass;
...
public ArrayList<StatisticsWithModeration> getStatisticsForSubjectPassWithModeration(int From,int To, String BranchId,String Sem,String ExamId, String SubjectBranchId) throws SQLException
{
    ...
    boolean flag=false;
    int Count=0,
    Reg=getTotalCountOfStudentsForCourse_Subject(SubjectBranchId,  ExamId);
    int passbeforemod=TotalPassForSubject(SubjectBranchId, ExamId);
    int totalpass=Reg-passbeforemod;
    try
    {
        con=new DBConnection().getConnection();
        while(i<=To)
        {
            ...
            String Query="select distinct StudentId,sum((ExternalMark+InternalMark)-b.PassMark) as Mark from StudentSubjectMark m "
                    ...
                    + " and IsAbsent!=1 group by StudentId ";
            ...
            while(Rs.next())
            {
             flag=true;
                ...
                stat.PassPercentage=(stat.TotalPass*100)/Reg;
                stat.TotalFail=totalpass-stat.TotalPass;
                stat.SemPass=totalpass+stat.TotalPass;
                 stat.SubjectBranchId=SubjectBranchId;
                 stat.TotalSubjectPass=j+passbeforemod;
            }
...
public ArrayList<StatisticsWithModeration> getStatisticsForSubjectPassWithModeration_forMBA(int From,int To, String BranchId,String Sem,String ExamId, String SubjectId) throws SQLException
{
    ArrayList<StatisticsWithModeration> Statistics=new ArrayList<StatisticsWithModeration>();
    Connection con=null;int i=From;
    Absentees abs=new Absentees();
    boolean flag=false;
    int Count=0,
    Reg=getTotalCountOfStudentsForCourse_MBA_Subject(SubjectId,  ExamId);
    int passbeforemod=abs.getTotalCountOfStudentsForPassedSubject_MBA(SubjectId, ExamId);
    int totalpass=Reg-passbeforemod;
    try
    {
        con=new DBConnection().getConnection();
        while(i<=To)
        {
            ...
            String Query="select distinct StudentId,sum((ExternalMark+InternalMark)-b.PassMark) as Mark from StudentSubjectMark m "
                    + " inner join SubjectBranchMaster b on b.SubjectBranchId=m.SubjectBranchId and b.BranchId=? and b.CurrentYearSem=?"
                    + "  inner join SubjectMaster s on b.SubjectId=s.SubjectId where s.SubjectId=? and m.ExamId=? and m.IsPassed=0  "
                    + " and IsAbsent!=1 group by StudentId ";
            ...
            while(Rs.next())
            {
             flag=true;
                ...
                stat.TotalFail=totalpass-stat.TotalPass;
                stat.SemPass=totalpass+stat.TotalPass;
                 stat.SubjectBranchId=SubjectId;
                 stat.TotalSubjectPass=j+passbeforemod;
            }
