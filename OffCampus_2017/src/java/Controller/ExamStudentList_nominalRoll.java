...
public class ExamStudentList_nominalRoll {
    ...
    public ExamStudentList_nominalRoll(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException {
        ...
        if (request.getParameter("course_applied") != null) {
         ...
         if (request.getParameter("join_year") != null) {
          ...
          if (request.getParameter("studenttype") != null) {
            ...
            request.getSession().setAttribute("studenttype", studenttype);
        ...
        if (request.getParameter("search_button") != null && request.getParameter("search_button").equals("Search")) {
              if(ExamId==null || ExamId.equals("-1"))
            {
              ...
              else if(CenterId==null || CenterId.equals("-1"))
            {
        ...
        else if(request.getParameter("search_button") != null && request.getParameter("search_button").equals("ok"))
        {
            ...
            if (BranchId != null && yearApplied != null)
            {
             ...
             if(request.getSession().getAttribute("studenttype")!=null)
            {
                studenttype=request.getSession().getAttribute("studenttype").toString();
            }
        }
          /* */
