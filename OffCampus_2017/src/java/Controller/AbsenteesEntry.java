...
public class AbsenteesEntry
{
HttpServletRequest request;
HttpServletResponse response;
String ExamId="-1",BranchId="-1",AcdemicYear="-1",Sem="-1",SubjectBranchId="-1",PRN=null,BranchSearch="-1",PRNSearch=null,SubjectSearch="-1",ExamError=null,BranchError=null,SubjectError=null,PRNError=null,SemError=null;
...
public AbsenteesEntry(HttpServletRequest request,HttpServletResponse response) throws SQLException
{
...
public String getPRNError() throws SQLException
{
    ...
    else if(absent.IsMarkEnteredForStudent(absent.getStudentIdFromPRN(PRN), SubjectBranchId, ExamId) && IsAbsent==1)
    {
...
{
    return absent.getTotalCountOfAbsenteeForSubject(SubjectBranchId, ExamId);
}
public int getTotalCountOfAbsenteesEntered() throws SQLException
{
    return absent.getTotalCountOfAbsenteesEntered(SubjectBranchId);
}
public int getTotalCountOfStudentsForSubject() throws SQLException
{
    return absent.getTotalCountOfStudentsForSubject(SubjectBranchId, ExamId);
}
public int getTotalCountOfMalPracticeEntered() throws SQLException
{
    return absent.getTotalCountOfMalPracticeEntered(SubjectBranchId);
}
public int getTotalCountOfMalPracticeForSubject() throws SQLException
{
    return absent.getTotalCountOfMalPracticeForSubject(SubjectBranchId, ExamId);
}
...
{
    return absent.getTotalCountOfMarkEnteredForSubject(SubjectBranchId, ExamId);
}
